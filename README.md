Showcase karma.conf.js linting errors in application and library, generated with nx.
...
![alt text](https://github.com/whernebrink/nrwl-airlines-karma/blob/main/no-issue-in-root.png?raw=true)

Karma linting issue in karma.conf.js (in application)
![alt text](https://github.com/whernebrink/nrwl-airlines-karma/blob/main/karma-linting-issue-in-app.png?raw=true)
